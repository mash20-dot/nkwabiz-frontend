  ...
  return (
    <TableContext.Provider value={{ size }}>
      <div
        {...props}
        className={cx(
          "overflow-hidden rounded-xl bg-primary border border-gray-200 shadow-xs",
          className
        )}
      >
        {children}
...
const TableCardHeader = ({
  ...
  return (
    <div
      className={cx(
        "relative flex flex-col items-start gap-4 border-b border-gray-200 bg-primary px-4 md:flex-row",
...
const TableHeader = <T extends object>({
  ...
  return (
    <AriaTableHeader
      ...
      className={(state) =>
        cx(
          "relative bg-gray-100/70 border-b border-gray-200",
          size === "sm" ? "h-9" : "h-11",
...
const TableRow = <T extends object>({
  ...
  return (
    <AriaRow
      ...
      className={(state) =>
        cx(
          "relative border-b border-gray-200 outline-focus-ring transition-colors after:pointer-events-none hover:bg-secondary focus-visible:outline-2 focus-visible:-outline-offset-2",
          size === "sm" ? "h-14" : "h-18",
...
const TableCell = ({ className, children, ...props }: TableCellProps) => {
  ...
  return (
    <AriaCell
      ...
      className={(state) =>
        cx(
          "relative text-sm text-gray-800 font-normal outline-focus-ring focus-visible:z-1 focus-visible:outline-2 focus-visible:-outline-offset-2",
          size === "sm" && "px-4 py-3",
          size === "md" && "px-6 py-4",
