...
const Products = () => {
  return (
    <div className="bg-white px-6 py-14 md:px-10 md:py-16 lg:px-20 lg:py-25 flex flex-col items-center gap-12 lg:gap-15">
      ...
      <div className="w-full flex flex-col gap-10 md:gap-15 lg:gap-15">
        <ProductCard className="group" image={SendSMS}>
          <div className="w-full md:w-1/2 lg:w-1/2 flex flex-col justify-center gap-4 md:px-8 lg:px-8 pb-6 lg:pb-0 md:pb-0">
        ...
        <ProductCard
          className="group lg:flex-row-reverse"
