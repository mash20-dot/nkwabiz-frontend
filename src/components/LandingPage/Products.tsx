...
const Products = () => {
  return (
    <div className="bg-white px-4 py-8 md:px-6 lg:px-16 lg:py-16 flex flex-col items-center gap-10">
      ...
      <div className="w-full flex flex-col gap-6">
        <ProductCard>
          <div className="w-1/2 flex flex-col justify-center gap-4 px-8">
            ...
            <Button className="bg-none border-none px-0 py-0 text-gray-500">
              Learn more
            </Button>
          </div>
        </ProductCard>
