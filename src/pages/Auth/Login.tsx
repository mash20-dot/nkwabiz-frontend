...
const Login = () => {
  ...
  return (
    <>
      <SEO
        title="Login - Access Your Bulk SMS Account | Nkwabiz"
        description="Login to your Nkwabiz account to send bulk SMS and manage your business in Ghana"
        canonical="https://www.nkwabiz.com/login"
        keywords="bulk sms login, nkwabiz login, business management login ghana"
      />
