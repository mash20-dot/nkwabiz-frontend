...
const TestimonialsPage = () => {
  const featuredTestimonials = [
    {
      content:
        "NkwaBiz transformed how I manage my small grocery store. I can now track inventory, monitor sales, and make better business decisions with the analytics dashboard. Since implementing the system, I've reduced stockouts by 70% and increased my monthly revenue by 25%.",
      author: "Grace Mensah",
    ...
    {
      content:
        "Since implementing NkwaBiz, I've reduced stockouts by 60% and increased my monthly revenue by tracking which products sell best. The interface is intuitive even for non-tech users like myself. My staff picked it up in just one day of training, and now we can't imagine running our store without it.",
      author: "Kwame Osei",
    ...
    {
      content:
        "As a new business owner, I needed something simple yet powerful to manage my shop. NkwaBiz provides exactly what I need without overwhelming me with complicated features. The low stock alerts have been particularly helpful, and I love being able to check my sales from anywhere.",
      author: "Abena Dankwa",
  ...
  const additionalTestimonials = [
    {
      content:
        "NkwaBiz has made managing my pharmacy much more efficient. I can easily track medication expiry dates and get alerts when stock is running low.",
    ...
    {
      content:
        "The analytics feature has been eye-opening for my business. I discovered that 30% of my revenue was coming from just 10% of my products, which helped me optimize my inventory.",
    ...
    {
      content:
        "I run three hardware stores, and NkwaBiz makes it easy to manage inventory across all locations. The mobile access means I can check stock levels even when I'm visiting suppliers.",
    ...
    {
      content:
        "The customer support team is exceptional. Whenever I've had questions, they've responded quickly and helped me solve any issues.",
    ...
    {
      content:
        "As someone who's not tech-savvy, I was worried about using a digital system. But NkwaBiz is so user-friendly, I was comfortable with it after just one day.",
      author: "Ibrahim Sule",
    ...
    {
      content:
        "The ability to track sales by time of day has helped me optimize my staffing. I now know exactly when I need extra help during peak hours.",
      author: "Ama Darko",
