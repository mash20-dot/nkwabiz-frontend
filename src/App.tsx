...
const WhatsAppButton = () => {
  ...
  const landingPages = ['/', '/about', '/features', '/testimonials', '/pricing', '/login', '/signup', '/forgot-password', '/reset-password'];
  const shouldShow = landingPages.includes(location.pathname);
